    ...
    <div>
      <nav className="navbar fixed-top navbar-expand-md navbar-dark nav__bg">
        <div className="container">
          <a className="navbar-brand nav__brand" href="#">宜‘s 網頁</a>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav ml-auto navbar-nav__full-screen">
              <li className="nav-item nav-item__full-screen">
                <a className="nav-link" href="#">關於甜點</a>
              </li>
              <li className="nav-item nav-item__full-screen">
      ...
      <header className="header">
        <div className="container d-flex flex-column align-items-center">
          <img src="images/hcy.png" alt="" className="header__image" />
          <h1 className="header__title">宜‘<strong>s</strong> 甜點</h1>
          <hr className="divider--light" />
          <p className="header__slogan">巧克力/草莓/香草/奶油</p>
        </div>
      </header>

      <article className="course py-3 py-sm-5">
        <div className="container">
          <h1 className="text-center">甜點</h1>
